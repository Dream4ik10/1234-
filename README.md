...
<html>
    ...
    <body>
        ...
        <main>
            <h1>Професіонали радять   <img src="https://tehnoaltyn.kz/wp-content/uploads/2023/06/iPhone.png" width="100px"></h1>
            <section class="info">
                <article class="post">
        ...
        <footer>
            <div class="contacts">
                <p class="footer-text"><span class="address">Адрес:</span> Місто Технологічне,<br/> пр-т Сучасний, 29/2  <img src="https://fs02.vseosvita.ua/0200avfi-ad0d.png" width="100"></p>
                <p class="footer-text"><span class="tel">Телефон:</span> 4138-564 <img src="https://tehnoaltyn.kz/wp-content/uploads/2023/06/iPhone.png" width="50px" height="50px"></p>
            </div>
